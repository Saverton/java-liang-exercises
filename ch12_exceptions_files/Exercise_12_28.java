...
public class Exercise_12_28 {
    ...
    public static void main(String[] args) {
        ...
        if (file.isFile()) {
            if (padFirstDigitInFileName(file))
            ...
            for (int i = 0; i < directory.length; i++) {
                if (padFirstDigitInFileName(directory[i]))
    ...
    /** 
     * Rename a file formatted as "Exercisei_j" such that if "i" is a  single digit, it is padded with a 0 to be 2 digits long (e.g. Exercise2_2 => Exercise02_2).
     ...
     */
    public static boolean padFirstDigitInFileName(File file) {
