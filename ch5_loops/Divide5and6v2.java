/**
 * Program to display all numbers from 100 to 1000 (10 per line) that are divisible by 5 or 6, but not both.
 * 
 * @author Scott M.
 * Divide5and6v2.java
 */

public class Divide5and6v2 {
    /**
    ...
    public static void main(String[] args) {
        ...
        for (int count = 100; count <= 1000; count += 1) {        
